...
def main():
    ...
    while current < stop:
        ...
        # df_combined_resampled.at[current, 'predicted_valve_level_prev_learn'] = predicted_valve_level_prev_learn
    ...
    # print('\nvalve mae prev learn: ',metrics.mean_absolute_error(df_combined_resampled.valve_level, df_combined_resampled.predicted_valve_level_prev_learn))
    ...
    # plt.plot(df_combined_resampled.index, df_combined_resampled.predicted_valve_level_prev_learn)
